...
if (isset($_POST['save'])) {
    ...
    $sql = "INSERT INTO `users`(name,email,password,mobile,address,gender) values('$name','$email','$hash','$mobile','$address','$gender')";
    $query = mysqli_query($con, $sql);

    if ($query) {
        $result = "<div class='alert alert-success text-center'>Data saved successfully 😊👌</div>";
    } else {
        $result = "<div class='alert alert-danger text-center'>Data failed to save 😢😢</div>";
    }
}
    ...
    <div class="container">
        ...
        <div class="container shadow-lg my-5">
            ...
            <div class="row py-2">
                ...
                $process =mysqli_query($con,$getData);




                while ($myData = mysqli_fetch_assoc($process)) {
